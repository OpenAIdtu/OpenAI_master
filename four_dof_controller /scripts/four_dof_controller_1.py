...
class four_dof_Controller(object):
    ...
    def __init__(self, name, action_name):
        ...
        self.pub_command=rospy.Publisher('Serial_command', Float64MultiArray, queue_size=10)
    ...
    def execute_cb(self, goal):
        ...
        for point in goal.trajectory.points:
            ...
            serial_command.data=point.positions-previous_position.data
             
            previous_position.data=point.positions           
...
if __name__ == '__main__':
    four_dof_Controller('four_dof_arm_controller', 'follow_joint_trajectory')
    rospy.spin()
